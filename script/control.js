...
button1.addEventListener('click',function(){
  ...
  Write.text2 = document.getElementById("textInput2").value;// get string from input
...
function processJson(jsonString) {
   ...
   console.log(Receive[index].text);
    while(index >= 0){
      displayString += index + " Time " + convertDate(Receive[index].date) + "<br>Name<br>" + Receive[index].text + "<br>Message<br>" + Receive[index].text2 + "<br></br>"
      index -= 1;
}
